...
spry::FullShader::FullShader(const char* vertShaderSource, const char* fragShaderSource, const char* geom_shader_source)
...
void spry::FullShader::compile_shader_code(const char* vertex, const char* fragment, const char* geometry)
{
...
void spry::FullShader::use()
{
    glUseProgram(ID);
}

void spry::FullShader::set_uniform_float(const char* name, const float value)
{
    int loc = glGetUniformLocation(ID, name);
    glUniform1f(loc, value);
}

void spry::FullShader::set_uniform_matrix(const char* name, const glm::mat4& value)
{
    int loc = glGetUniformLocation(ID, name);
    glUniformMatrix4fv(loc, 1, GL_FALSE, glm::value_ptr(value));
}

void spry::FullShader::set_uniform_vec(const char* name, const glm::vec3&& value)
{
    int loc = glGetUniformLocation(ID, name);
...
void spry::FullShader::set_uniform_vec(const char* name, const glm::vec4&& value)
{
    int loc = glGetUniformLocation(ID, name);
...
void spry::FullShader::set_uniform_int(const char* name, const int value) const
{
    int loc = glGetUniformLocation(ID, name);
...
void spry::FullShader::set_shader_paths(const char* vert_shader_path, const char* frag_shader_path, const char* geom_shader_path)
{
...
void spry::FullShader::set_shader_code(const char* vert_shader_source, const char* frag_shader_source, const char* geom_shader_source)
{
    compile_shader_code(vert_shader_source, frag_shader_source, geom_shader_source);
    mHasCompiled = true;
}

spry::FullShader spry::ShaderManager::simple_shader()
{
    FullShader shader("", "");
...
spry::FullShader spry::ShaderManager::mvp_shader()
{
    FullShader shader("", "");
    shader.mHasCompiled = true;
...
spry::FullShader spry::ShaderManager::create_shader(const char* vert_code, const char* frag_code, const char *geom_code)
{
    FullShader shader("", "");
    shader.mHasCompiled = true;
